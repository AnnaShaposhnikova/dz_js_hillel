//Задача, сделать страничку, которая отображает всех пользователей. (пользователей получаем с https://jsonplaceholder.typicode.com/users
...
//Все наши действия реализовываем через запросы на джейсон плейсхолдер (https://jsonplaceholder.typicode.com/guide/)
